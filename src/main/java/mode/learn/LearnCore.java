    ...
    public void execute() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                core();
                System.out.println("Learn mode execute duration : " +
                        Time.timeFormatEnglish(Time.now()  - start));
                System.out.println("Learning Mode: Out degree avg : " + GraphInfo.getOutdegreeAvg() +
                        ", Path Avg length : " + GraphInfo.getPathAvgLength());
